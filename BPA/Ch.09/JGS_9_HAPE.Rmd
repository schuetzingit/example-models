...
simulateHistoriesHAPE <- function(PSI_STATES, PSI_OBS, N, unobservable = NA) { 
...
n[ , 1] <- rep(1000, n.occasions)	# Releases in study area
#n[ , 1] <- c(100, 0, 0, 0, 0)	# Releases in study area
...
# Execute simulation function
sim <- simulateHistoriesHAPE(PSI.STATE, PSI.OBS, n, unobservable = 3)
sim <- simul.ms(PSI.STATE, PSI.OBS, n, unobservable = 3)
